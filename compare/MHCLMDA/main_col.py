...
parent_dir_ = 'data/miR2Disease/ten-folds_balance'
simData = load_pkl(parent_dir, 'sim_mut.pkl')
Acc = []
Pre = []
Rec = []
Spe = []
...
for i in range(10):
    ...
    accuracy, precision, recall, specificity, mcc, f1, auc_, aupr_ = train(50, train_data) #######
    Acc.append(accuracy)
