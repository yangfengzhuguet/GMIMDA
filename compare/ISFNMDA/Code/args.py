...
def config():
    ...
    # dataset
    # original datasets
    parser.add_argument('-miRNA', type=str, default=['circCosSim', 'circGIPSim', 'circFunSim'])
    parser.add_argument('-disease', type=str, default=['disCosSim', 'disGIPSim', 'disSSim'])
    # MACFE
    ...
    parser.add_argument('-CFE_miRNA_num', type=int, default=585) # 853
    parser.add_argument('-CFE_hidden_miRNA', type=int, default=[700, 500, 585])  #
    parser.add_argument('-CFE_batch_size_disease', type=int, default=256)
    parser.add_argument('-CFE_disease_num', type=int, default=88) # 591
    parser.add_argument('-CFE_hidden_disease', type=int, default=[500, 300, 88])

    parser.add_argument('-datapath', type=str, default='../Data/circRNA-disease_datasets/')
    parser.add_argument('-savepath', type=str, default='./result/')
    parser.add_argument('-m_num', type=int, default=585)
    parser.add_argument('-d_num', type=int, default=88)
    ...
    parser.add_argument('-lr', type=float, default=0.01, choices=[0.01]) # 0.01
